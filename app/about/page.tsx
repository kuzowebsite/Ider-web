      ...
      <section className="relative">
        <div className="relative h-[300px] w-full overflow-hidden md:h-[400px]">
          <Image
            ...
            alt={`${t("university_name")} - ${t("about_page_title")}`}
            width={1920}
            height={400}
          ...
          <div className="absolute inset-0">
            <AnimatedHero title={t("about_page_title")} description={t("about_page_description")} />
          </div>
        </div>
      </section>
        ...
        <Tabs defaultValue="overview" className="w-full">
          <AnimatedElement direction="down">
            <TabsList className="mb-8 grid w-full grid-cols-2 md:grid-cols-4 lg:w-auto">
              ...
              <TabsTrigger value="history">{t("history_tab")}</TabsTrigger>
              <TabsTrigger value="leadership">{t("leadership_tab")}</TabsTrigger>
              <TabsTrigger value="values">{t("values_tab")}</TabsTrigger>
            </TabsList>
          </AnimatedElement>
          ...
          <TabsContent value="overview" className="space-y-12">
            <div className="grid gap-8 md:grid-cols-2">
              <AnimatedElement direction="left">
                <h2 className="mb-6 text-3xl font-bold">{t("university_intro_title")}</h2>
                <div className="space-y-4 text-muted-foreground">
                  <p>{t("university_intro_p1")}</p>
                  <p>{t("university_intro_p2")}</p>
                </div>
              </AnimatedElement>
            ...
            <AnimatedElement direction="up">
              <h2 className="mb-6 text-3xl font-bold">{t("mission_title")}</h2>
              <div className="rounded-lg bg-primary/5 p-6 md:p-8">
                <div className="flex flex-col items-center gap-6 md:flex-row">
                  ...
                  <div>
                    <p className="text-lg font-medium md:text-xl">{t("mission_text")}</p>
                  </div>
                </div>
              </div>
            </AnimatedElement>
                ...
                <div className="rounded-lg bg-primary/5 p-6 md:p-8">
                  <div className="space-y-4">
                    ...
                    <ul className="ml-6 list-disc space-y-2">
                      ...
                      <li>Судалгаа, шинжилгээний ажилд оролцох боломж олгох</li>
