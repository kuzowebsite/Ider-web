      ...
      <section className="relative">
        <div className="relative h-[300px] w-full overflow-hidden md:h-[400px]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center text-white">
            <h1 className="mb-4 text-4xl font-bold md:text-5xl lg:text-6xl">Бидний тухай</h1>
            <p className="max-w-2xl text-lg md:text-xl">
              Идэр их сургуулийн түүх, эрхэм зорилго, үнэт зүйлс болон удирдлагын багийн талаар
            </p>
          </div>
        </div>
      </section>
        ...
        <Tabs defaultValue="overview" className="w-full">
          ...
          <TabsContent value="leadership" className="space-y-12">
            ...
            <div>
              ...
              <p className="mb-8 max-w-3xl text-muted-foreground">
                Идэр их сургуулийн удирдах зөвлөл нь сургуулийн стратегийн чиглэлийг тодорхойлж, үйл ажиллагаанд хяналт
                тавьдаг. Зөвлөлийн гишүүд нь боловсрол, бизнес, нийгмийн салбарын нэр хүндтэй төлөөлөгчид юм.
              </p>
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <LeadershipCard
                  name="Ц. Баярсайхан"
